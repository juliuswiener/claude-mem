...
export class SessionStore {
  ...
  // v53 — `where` and `why` per observation. Was written as v51 in this fork
  // before the 13.25.2 merge; upstream has since taken v51 (tool_uses) and v52
  // (telegram_wrapups), and the live DB already carries both. Renumbered rather
  // than kept, because two migrations under one number leave a DB that reports a
